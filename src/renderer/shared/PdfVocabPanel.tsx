    ...
    <ErrorBoundary>
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h3 className="text-xl font-bold text-gray-900">Vocab Deck</h3>
            <p className="text-xs text-gray-500">Your vocabulary</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 space-y-4">
        <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-100">
          <div className="mb-4">
            <p className="text-xs font-semibold text-gray-600 uppercase tracking-wide mb-2">Deck Name</p>
            <p className="text-lg font-bold text-gray-900">{baseName}</p>
          </div>

          <div className="pt-4 border-t border-blue-200">
            <p className="text-xs font-semibold text-gray-600 uppercase tracking-wide mb-2">Total Words</p>
            <div className="flex items-center gap-3">
              <div className="text-4xl font-bold text-blue-600">{rowCount}</div>
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 mt-1">Keep building your vocabulary!</p>
              </div>
            </div>
          </div>
        </div>
